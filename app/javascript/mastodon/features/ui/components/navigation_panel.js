...
const NavigationPanel = () => (
  <div className="navigation-panel">
    ...
    <NavLink className="column-link column-link--transparent" to="/circles">
      <Icon className="column-link__icon" id="user-circle" fixedWidth />
      <FormattedMessage id="navigation_bar.circles" defaultMessage="Circles" />
    </NavLink>
    {profile_directory && (
