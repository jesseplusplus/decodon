...
const links = [
  ...
  >
    ...
    <span className="tabs-bar__link__full-label">
      <FormattedMessage id="tabs_bar.home" defaultMessage="Home" />
    </span>
    <span className="tabs-bar__link__short-label">
      <FormattedMessage id="navigation_bar.short.home" defaultMessage="Home" />
    </span>
  </NavLink>,
  <NavLink
    className="tabs-bar__link tabs-bar__limited"
    to="/timelines/limited"
    data-preview-title-id="column.limited"
    data-preview-icon="lock"
  >
    <Icon id="lock" fixedWidth />
    <span className="tabs-bar__link__full-label">
      <FormattedMessage
  ...
  <NavLink
    ...
    exact
    to="/lists"
    data-preview-title-id="column.lists"
    data-preview-icon="list-ul"
  >
    <Icon id="list-ul" fixedWidth />
    <span className="tabs-bar__link__full-label">
      <FormattedMessage id="tabs_bar.lists" defaultMessage="Lists" />
    </span>
    <span className="tabs-bar__link__short-label">
      <FormattedMessage id="navigation_bar.short.lists" defaultMessage="List" />
    </span>
  </NavLink>,
  <NavLink
  ...
  >
    ...
    <span className="tabs-bar__link__short-label">
      <FormattedMessage
        id="navigation_bar.short.search"
  ...
  <NavLink
    className="tabs-bar__link hamburger"
    to="/getting-started"
  ...
  handleClick = (e) => {
    ...
    if (isUserTouching()) {
      ...
      requestAnimationFrame(() => {
        ...
        const {
          props: { to },
        } = getLinks()[Array(...this.node.childNodes).indexOf(nextTab)];
  ...
  render() {
    ...
    return (
      <div className="tabs-bar__wrapper">
        <nav
          className={classNames("tabs-bar", {
            "bottom-bar": place_tab_bar_at_bottom,
          })}
          ref={this.setRef}
        >
          {getLinks().map((link) =>
            React.cloneElement(link, {
              ...
              onClick: link.props.href ? null : this.handleClick,
