...
const CircleItem: React.FC<{
  ...
  return (
    <div className='lists__item'>
      <Link to={`/circles/${id}/members`} className='lists__item__title'>
        <Icon id='motion_photos_on' icon={MotionPhotosOnIcon} />
        <span>{title}</span>
      </Link>
    ...
    <>
      <span>
        ...
        <FormattedMessage
          ...
          defaultMessage='Create a new circle to organize your mutual connections'
        />
      </span>
