...
class ActivityPub::FetchRemoteStatusService < BaseService
  ...
  def call(uri, prefetched_body: nil, on_behalf_of: nil, expected_actor_uri: nil, request_id: nil, depth: nil, conversation: nil)
    ...
    ActivityPub::Activity.factory(activity_json, actor, request_id: @request_id, depth: @depth, conversation: conversation).perform
  end
